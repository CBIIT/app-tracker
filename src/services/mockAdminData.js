...
export const mockSystemAudit = {
	...
	recentEvents: [
		...
		{
			eventId: 'EVT006',
			timestamp: '2026-07-07T20:05:22Z',
			user_id: 'alee@example.com',
			action: 'download',
			resource: 'Applicant List - VAC002',
			ipAddress: '192.168.1.105',
			status: 'success',
		},
		{
			eventId: 'EVT007',
			timestamp: '2026-07-07T20:00:18Z',
			user_id: 'pburns@example.com',
			action: 'upload',
			resource: 'Committee Scores - Batch 5',
			ipAddress: '192.168.1.106',
			status: 'success',
		},
		{
			eventId: 'EVT008',
			timestamp: '2026-07-07T19:55:30Z',
			user_id: 'sgarcia@example.com',
			action: 'view',
			resource: 'Vacancy VAC005 Details',
			ipAddress: '192.168.1.107',
			status: 'success',
		},
		{
			eventId: 'EVT009',
			timestamp: '2026-07-07T19:50:44Z',
			user_id: 'mwong@example.com',
			action: 'delete',
			resource: 'Draft Application - VAC003-APP789',
			ipAddress: '192.168.1.108',
			status: 'success',
		},
		{
			eventId: 'EVT010',
			timestamp: '2026-07-07T19:45:55Z',
			user_id: 'tchen@example.com',
			action: 'edit',
			resource: 'Committee Member Access Levels',
