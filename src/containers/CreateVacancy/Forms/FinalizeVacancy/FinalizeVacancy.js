...
const finalizeVacancy = (props) => {
	...
	const { auth } = useAuth();
	const { user } = auth;
	const hideForReadOnly = props.hideForReadOnly
	...
	return (
		<>
			...
			<div className='SectionContent' style={props.sectionContentStyle}>
				...
				{!hideForReadOnly && <div><h2>Number of Scoring Categories</h2>
			...
			{props.hideCommitteeSection || hideForReadOnly ? null : (
				<>
					<SectionHeader
			...
			{props.hideEmails || hideForReadOnly ? null : (
				<>
					<SectionHeader
