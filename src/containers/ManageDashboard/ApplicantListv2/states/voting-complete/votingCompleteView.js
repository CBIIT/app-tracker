...
import getVotingCompleteColumns from './votingCompleteColumns';
import mapVotingCompleteChange from './mapVotingCompleteTableChange';
...
const VotingCompleteView = (props) => {
	// Modal state for reference, regret email, voting comments flow
	...
	const [referredToInterview, setReferredToInterview] = useState('0');
	...
	const renderExpandedScores = useCallback(
		// Expandable rows render committee score for each applicant.
...
export default VotingCompleteView;
