import CandidateDidNotInterview from './CandidateDidNotInterview';
import { render, screen, fireEvent } from '@testing-library/react';

describe('CandidateDidNotInterview', () => {
    let mockAppSysId;
    ...
    test('renders CandidateDidNotInterview component if Rejection Email has not been sent', () => {
        mockRejectionEmailSent = '0';

        render(<CandidateDidNotInterview 
        ...
        expect(screen.getByText('Ready to Send Candidate Did Not Interview Rejection Email')).toBeInTheDocument();
    ...
    test('renders CandidateDidNotInterview component if Rejection Email has been sent', () => {
        ...
        expect(screen.getByText('Candidate Did Not Interview Rejection Email Already Sent.')).toBeInTheDocument();
