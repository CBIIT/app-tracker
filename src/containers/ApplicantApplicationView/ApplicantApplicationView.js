					...
					return (
						<div key={index}>
							...
							<InfoCardRow>
								...
								/>
								<LabelValuePair label='Last Name' value={reference.lastName} />
							</InfoCardRow>
							<InfoCardRow>
								<LabelValuePair label='Email Address' value={reference.email} />
							</InfoCardRow>
							<InfoCardRow>
								<LabelValuePair label='Phone Number' value={reference.phone} />
								<LabelValuePair
									label='Relationship'
